...
public sealed class AdminNotificationService : IAdminNotificationService
{
    ...
    public AdminNotificationService(IUnitOfWork uow) => _uow = uow;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var rows = await _uow.Repository<Notification, long>().Query
            .AsNoTracking()
        ...
        return rows
            .Select(n => new AdminNotificationRowDto(
                n.Id,
                n.Title,
                n.Message,
                n.Type,
                NotificationTypes.AdminLinkPath(n.Type),
                n.CreatedAt,
                n.IsRead))
            .ToList();
    }
