        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_Files_ImageFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantId = table.Column<long>(type: "bigint", nullable: true),
                    DriverUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_ShoppingCartId_MenuItemId",
                table: "CartItems",
                columns: new[] { "ShoppingCartId", "MenuItemId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantStaff_UserId_RestaurantId",
                table: "RestaurantStaff",
                columns: new[] { "UserId", "RestaurantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_OrderId_Subject",
                table: "Reviews",
                columns: new[] { "OrderId", "Subject" },
                unique: true);
