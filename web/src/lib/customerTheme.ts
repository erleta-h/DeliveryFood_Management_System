...
import { landingShellBg } from './landingTheme'

/** Sfondi i plotë i faqes /app — i njëjti gradient si LandingPage (faqja e parë). */
export const customerShellBg = landingShellBg
