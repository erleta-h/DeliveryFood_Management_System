...
export function AdminTopBar() {
  ...
  return (
    <header className="shrink-0 border-b border-gray-200/90 bg-white px-4 py-3 lg:px-8">
      <div className="mx-auto flex max-w-[1600px] items-center justify-between gap-3">
        <p className="text-sm font-medium text-gray-500 lg:hidden">Paneli admin</p>
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="hidden rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-sm font-medium text-red-700 transition hover:bg-red-100 sm:inline-flex"
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 py-1.5 pl-1.5 pr-3 transition hover:border-violet-200 hover:bg-violet-50/50"
