...
const QUICK_FILTERS: { id: QuickFilterId; label: string; icon: string }[] = [
  ...
  { id: 'popular', label: 'Popullore', icon: '🔥' },
...
const filterSelect =
  'restaurant-toolbar-select h-8 min-h-8 cursor-pointer appearance-none rounded-full border border-white/[0.12] bg-[#1b2233] py-0 pl-3 pr-8 text-xs font-medium text-zinc-100 outline-none transition hover:border-white/[0.18] focus:border-orange-400/45 focus:ring-2 focus:ring-orange-400/15'
    ...
    <div className="space-y-2.5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <select
          ...
          className={`${filterSelect} max-w-[10rem] truncate sm:max-w-none`}
        >
