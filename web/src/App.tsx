...
const DriverActiveDeliveryPage = lazy(() => import('./pages/DriverActiveDeliveryPage'))
const DriverOrdersPage = lazy(() => import('./pages/DriversOrderPage'))
const DriverChatPage = lazy(() => import('./pages/DriverChatPage'))
